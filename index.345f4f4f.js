...
async function eF(){try{let t=await eP(e_),e=await t.results;eD(e)}catch(t){console.log(t)}}const eM=document.querySelector(".main-section");let eI=[];function eD(t){let e=[];eM.innerHTML="",t.forEach(t=>{//We need to add link that brings us to modal window if we press .main__photo-card
...
//# sourceMappingURL=index.345f4f4f.js.map
