...
async function eF(){let t=await eP(e_),e=await t.results;eD(e)}const eM=document.querySelector(".main-section");let eI=[];function eD(t){let e=[];eM.innerHTML="",t.forEach(t=>{//We need to add link that brings us to modal window if we press .main__photo-card
...
//# sourceMappingURL=index.d0f8c387.js.map
