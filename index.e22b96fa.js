...
const{Axios:el,AxiosError:ec,CanceledError:eh,isCancel:ep,CancelToken:ed,VERSION:ey,all:eg,Cancel:em,isAxiosError:eb,spread:ew,toFormData:eE,AxiosHeaders:ev,HttpStatusCode:eA,formToJSON:eO,getAdapter:eS,mergeConfig:eR}=ef;ef.defaults.baseURL="https://api.themoviedb.org/3/movie/popular",ef.defaults.params={api_key:"95f474a01cc4252905d63c7d958d5749",language:"en-US",page:1};const eT=async()=>{try{let t=await ef.get();// Here I implemented response async/await fn, check what we gonna recive and then work with it
return console.log(t)}catch(t){console.log(t)}},eU={method:"GET",url:"https://api.themoviedb.org/3/movie/popular?language=en-US&page=1",headers:{accept:"application/json",Authorization:"Bearer 95f474a01cc4252905d63c7d958d5749"}},eB=async()=>{try{let t=await ef.request(eU),e=await t.data;return console.log(e)}catch(t){console.log(t)}};eT(),eB(),console.log(123);//# sourceMappingURL=index.e22b96fa.js.map

//# sourceMappingURL=index.e22b96fa.js.map
