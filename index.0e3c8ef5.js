 ...
 */function tC(t){return encodeURIComponent(t).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function tx(t,e,r){let n;/*eslint no-param-reassign:0*/if(!e)return t;let o=r&&r.encode||tC,i=r&&r.serialize;if(n=i?i(e,r):k.isURLSearchParams(e)?e.toString():new tU(e,r).toString(o)){let e=t.indexOf("#");-1!==e&&(t=t.slice(0,e)),t+=(-1===t.indexOf("?")?"?":"&")+n}return t}tB.append=function(t,e){this._pairs.push([t,e])},tB.toString=function(t){let e=t?function(e){return t.call(this,e,tT)}:tT;return this._pairs.map(function(t){return e(t[0])+"="+e(t[1])},"").join("&")};var tj=class{constructor(){this.handlers=[]}/**
   ...
   *
   * @returns {void}
   */forEach(t){k.forEach(this.handlers,function(e){null!==e&&t(e)})}},tL={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},tN="undefined"!=typeof URLSearchParams?URLSearchParams:tU,tP="undefined"!=typeof FormData?FormData:null,t_="undefined"!=typeof Blob?Blob:null;/**
 ...
 */tq=t=>{let e,r,n;let o={};return t&&t.split("\n").forEach(function(t){n=t.indexOf(":"),e=t.substring(0,n).trim().toLowerCase(),r=t.substring(n+1).trim(),!e||o[e]&&tz[e]||("set-cookie"===e?o[e]?o[e].push(r):o[e]=[r]:o[e]=o[e]?o[e]+", "+r:r)}),o};const tH=Symbol("internals");function tJ(t){return t&&String(t).trim().toLowerCase()}function tV(t){return!1===t||null==t?t:k.isArray(t)?t.map(tV):String(t)}const tW=t=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(t.trim());function tK(t,e,r,n,o){if(k.isFunction(n))return n.call(this,e,r);if(o&&(e=r),k.isString(e)){if(k.isString(n))return -1!==e.indexOf(n);if(k.isRegExp(n))return n.test(e)}}class t${constructor(t){t&&this.set(t)}set(t,e,r){let n=this;function o(t,e,r){let o=tJ(e);if(!o)throw Error("header name must be a non-empty string");let i=k.findKey(n,o);i&&void 0!==n[i]&&!0!==r&&(void 0!==r||!1===n[i])||(n[i||e]=tV(t))}let i=(t,e)=>k.forEach(t,(t,r)=>o(t,r,e));return k.isPlainObject(t)||t instanceof this.constructor?i(t,e):k.isString(t)&&(t=t.trim())&&!tW(t)?i(tq(t),e):null!=t&&o(e,t,r),this}get(t,e){if(t=tJ(t)){let r=k.findKey(this,t);if(r){let t=this[r];if(!e)return t;if(!0===e)return function(t){let e;let r=Object.create(null),n=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;for(;e=n.exec(t);)r[e[1]]=e[2];return r}(t);if(k.isFunction(e))return e.call(this,t,r);if(k.isRegExp(e))return e.exec(t);throw TypeError("parser must be boolean|regexp|function")}}}has(t,e){if(t=tJ(t)){let r=k.findKey(this,t);return!!(r&&void 0!==this[r]&&(!e||tK(this,this[r],r,e)))}return!1}delete(t,e){let r=this,n=!1;function o(t){if(t=tJ(t)){let o=k.findKey(r,t);o&&(!e||tK(r,r[o],o,e))&&(delete r[o],n=!0)}}return k.isArray(t)?t.forEach(o):o(t),n}clear(t){let e=Object.keys(this),r=e.length,n=!1;for(;r--;){let o=e[r];(!t||tK(this,this[o],o,t,!0))&&(delete this[o],n=!0)}return n}normalize(t){let e=this,r={};return k.forEach(this,(n,o)=>{let i=k.findKey(r,o);if(i){e[i]=tV(n),delete e[o];return}let s=t?o.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(t,e,r)=>e.toUpperCase()+r):String(o).trim();s!==o&&delete e[o],e[s]=tV(n),r[s]=!0}),this}concat(...t){return this.constructor.concat(this,...t)}toJSON(t){let e=Object.create(null);return k.forEach(this,(r,n)=>{null!=r&&!1!==r&&(e[n]=t&&k.isArray(r)?r.join(", "):r)}),e}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([t,e])=>t+": "+e).join("\n")}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(t){return t instanceof this?t:new this(t)}static concat(t,...e){let r=new this(t);return e.forEach(t=>r.set(t)),r}static accessor(t){let e=this[tH]=this[tH]={accessors:{}},r=e.accessors,n=this.prototype;function o(t){let e=tJ(t);r[e]||(!function(t,e){let r=k.toCamelCase(" "+e);["get","set","has"].forEach(n=>{Object.defineProperty(t,n+r,{value:function(t,r,o){return this[n].call(this,e,t,r,o)},configurable:!0})})}(n,t),r[e]=!0)}return k.isArray(t)?t.forEach(o):o(t),this}}function tG(t,e){let r=this||tM,n=e||r,o=t$.from(n.headers),i=n.data;return k.forEach(t,function(t){i=t.call(r,i,o.normalize(),e?e.status:void 0)}),o.normalize(),i}function tX(t){return!!(t&&t.__CANCEL__)}/**
...
u.ontimeout=function(){let e=t.timeout?"timeout of "+t.timeout+"ms exceeded":"timeout exceeded",n=t.transitional||tL;t.timeoutErrorMessage&&(e=t.timeoutErrorMessage),r(new M(e,n.clarifyTimeoutError?M.ETIMEDOUT:M.ECONNABORTED,t,u)),// Clean up request
...
u.send(o||null)})};const t4={http:null,xhr:t6};k.forEach(t4,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
}Object.defineProperty(t,"adapterName",{value:e})}});var t8={getAdapter:t=>{let e,r;t=k.isArray(t)?t:[t];let{length:n}=t;for(let o=0;o<n&&(e=t[o],!(r=k.isString(e)?t4[e.toLowerCase()]:e));o++);if(!r){if(!1===r)throw new M(`Adapter ${e} is not supported by the environment`,"ERR_NOT_SUPPORT");throw Error(k.hasOwnProp(t4,e)?`Adapter '${e}' is not available in the build`:`Unknown adapter '${e}'`)}if(!k.isFunction(r))throw TypeError("adapter is not a function");return r},adapters:t4};/**
 * Throws a `CanceledError` if cancellation has been requested.
 *
 * @param {Object} config The config that is to be used for the request
 *
 * @returns {void}
 */function t3(t){if(t.cancelToken&&t.cancelToken.throwIfRequested(),t.signal&&t.signal.aborted)throw new tY(null,t)}function t7(t){t3(t),t.headers=t$.from(t.headers),// Transform request data
t.data=tG.call(t,t.transformRequest),-1!==["post","put","patch"].indexOf(t.method)&&t.headers.setContentType("application/x-www-form-urlencoded",!1);let e=t8.getAdapter(t.adapter||tM.adapter);return e(t).then(function(e){return t3(t),// Transform response data
e.data=tG.call(t,t.transformResponse,e),e.headers=t$.from(e.headers),e},function(e){return!tX(e)&&(t3(t),e&&e.response&&(e.response.data=tG.call(t,t.transformResponse,e.response),e.response.headers=t$.from(e.response.headers))),Promise.reject(e)})}const t9=t=>t instanceof t$?t.toJSON():t;function et(t,e){// eslint-disable-next-line no-param-reassign
 ...
 */class es{constructor(t){this.defaults=t,this.interceptors={request:new tj,response:new tj}}/**
   * Dispatch a request
   *
...
let a=s&&k.merge(s.common,s[e.method]);s&&k.forEach(["delete","get","head","post","put","patch","common"],t=>{delete s[t]}),e.headers=t$.concat(a,s);// filter out skipped interceptors
...
ef.mergeConfig=et,ef.AxiosHeaders=t$,ef.formToJSON=t=>tk(k.isHTMLForm(t)?new FormData(t):t),ef.getAdapter=t8.getAdapter,ef.HttpStatusCode=eu,ef.default=ef;// This module is intended to unwrap Axios default export as named.
// Keep top-level export same with static properties
// so that it can keep same with es module or cjs
const{Axios:el,AxiosError:ec,CanceledError:eh,isCancel:ep,CancelToken:ed,VERSION:ey,all:eg,Cancel:em,isAxiosError:eb,spread:ew,toFormData:eE,AxiosHeaders:ev,HttpStatusCode:eA,formToJSON:eO,getAdapter:eS,mergeConfig:eR}=ef;ef.defaults.baseURL="https://api.themoviedb.org/3/movie/popular",ef.defaults.params={api_key:"95f474a01cc4252905d63c7d958d5749",language:"en-US",page:1};const eT={method:"GET",url:"https://api.themoviedb.org/3/movie/popular?language=en-US&page=1",headers:{accept:"application/json",Authorization:"Bearer 95f474a01cc4252905d63c7d958d5749"}},eU=async()=>{try{let t=await ef.request(eT),e=await t.data;return e}catch(t){console.log(t)}},eB=async()=>{try{let t=await ef.get("https://api.themoviedb.org/3/genre/movie/list",{params:{api_key:"95f474a01cc4252905d63c7d958d5749"}}),e=await t.data.genres;return e}catch(t){console.error(t.message)}},eC=document.querySelector(".main-section");let ex=[];async function ej(){await eU().then(t=>{!function(t){t.forEach(t=>{//We need to add link that brings us to modal window if we press .main__photo-card
