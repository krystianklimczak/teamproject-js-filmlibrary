...
let t=[];for(let r of e.genre_ids)tI.map(e=>{e.id===r&&t.push(e.name)});let n=document.createElement("div");n.classList.add("film-poster"),n.setAttribute("value",e.id),null===e.poster_path&&(e.poster_path="/uc4RAVW1T3T29h6OQdr7zu4Blui.jpg"),n.insertAdjacentHTML("afterbegin",`<img class="film-poster__photo" src="https://image.tmdb.org/t/p/original${e.poster_path}" alt="${e.title}" loading="lazy"/>`);let i=document.createElement("div");i.classList.add("film-poster__description");let o=document.createElement("button");o.classList.add("film-poster__button"),o.setAttribute("type","button"),o.setAttribute("value",`${e.id}`),o.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24"><path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"/></svg>',o.addEventListener("click",e=>{tC(e.target.value).then(e=>{!function(e){// `<iframe width="560" height="315" src="https://www.youtube.com/embed/${key}?si=NP4x3PPUZd7lNCFY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`,
