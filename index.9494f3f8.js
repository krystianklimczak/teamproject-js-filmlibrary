 ...
 */function(e){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(e):e&&e.buffer&&g(e.buffer)},isString:y,isNumber:b,isBoolean:e=>!0===e||!1===e,isObject:w,isPlainObject:E,isUndefined:p,isDate:v,isFile:L,isBlob:A,isRegExp:x,isFunction:m,isStream:e=>w(e)&&m(e.pipe),isURLSearchParams:O,isTypedArray:C,isFileList:S,forEach:T,merge:/**
 ...
 */function eB(e){return encodeURIComponent(e).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function eC(e,t,r){let n;/*eslint no-param-reassign:0*/if(!t)return e;let i=r&&r.encode||eB,o=r&&r.serialize;if(n=o?o(t,r):M.isURLSearchParams(t)?t.toString():new eR(t,r).toString(i)){let t=e.indexOf("#");-1!==t&&(e=e.slice(0,t)),e+=(-1===e.indexOf("?")?"?":"&")+n}return e}eU.append=function(e,t){this._pairs.push([e,t])},eU.toString=function(e){let t=e?function(t){return e.call(this,t,eT)}:eT;return this._pairs.map(function(e){return t(e[0])+"="+t(e[1])},"").join("&")};var ek=class{constructor(){this.handlers=[]}/**
   ...
   *
   * @returns {void}
   */forEach(e){M.forEach(this.handlers,function(t){null!==t&&e(t)})}},ej={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},ex="undefined"!=typeof URLSearchParams?URLSearchParams:eR,e_="undefined"!=typeof FormData?FormData:null,eN="undefined"!=typeof Blob?Blob:null;/**
...
self instanceof WorkerGlobalScope&&"function"==typeof self.importScripts;var eD={classes:{URLSearchParams:ex,FormData:e_,Blob:eN},isStandardBrowserEnv:eP,isStandardBrowserWebWorkerEnv:eF,protocols:["http","https","file","blob","url","data"]},eM=/**
...
u.ontimeout=function(){let t=e.timeout?"timeout of "+e.timeout+"ms exceeded":"timeout exceeded",n=e.transitional||ej;e.timeoutErrorMessage&&(t=e.timeoutErrorMessage),r(new I(t,n.clarifyTimeoutError?I.ETIMEDOUT:I.ECONNABORTED,e,u)),// Clean up request
 ...
 */class ts{constructor(e){this.defaults=e,this.interceptors={request:new ek,response:new ek}}/**
   * Dispatch a request
   *
...
let t=document.createElement("div");t.classList.add("modal-trailer"),t.insertAdjacentHTML("afterbegin",`<iframe class="modal-trailer__iframe" src="https://www.youtube.com/embed/${e}?si=NP4x3PPUZd7lNCFY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`),tk.innerHTML="",tk.insertAdjacentElement("afterbegin",t),tk.classList.remove("is-hidden"),document.body.style.overflow="hidden",tk.addEventListener("click",()=>{tk.classList.add("is-hidden"),tk.innerHTML="",document.body.style.overflow="auto"}),document.addEventListener("keydown",tj)}(e)});// showTrailer(trailerKey);
        ...
        </div>`),n.insertAdjacentElement("beforeend",i),r.push(n)}),tD.append(...r)}tR().then(e=>tM.push(...e)).catch(e=>console.log(e));const tH=document.querySelector(".search-form"),tz=document.querySelector(".search-form__input"),t$=document.querySelector(".search-form__svg");async function tJ(e,t){try{let r=await tB(e,t),n=await r.results;return tq(n),tN(e,t),tP(e,t)}catch(e){console.log(e)}}tI(),tH.addEventListener("submit",e=>{e.preventDefault();let t={api_key:"95f474a01cc4252905d63c7d958d5749",language:"en-US",page:1,query:`${tz.value}`};tJ("https://api.themoviedb.org/3/search/movie",t)}),t$.addEventListener("click",e=>{let t={api_key:"95f474a01cc4252905d63c7d958d5749",language:"en-US",page:1,query:`${tz.value}`};tJ("https://api.themoviedb.org/3/search/movie",t)});//# sourceMappingURL=index.9494f3f8.js.map

//# sourceMappingURL=index.9494f3f8.js.map
