...
const{toString:u}=Object.prototype,{getPrototypeOf:l}=Object,c=(t=Object.create(null),e=>{let r=u.call(e);return t[r]||(t[r]=r.slice(8,-1).toLowerCase())}),f=e=>(e=e.toLowerCase(),t=>c(t)===e),d=e=>t=>typeof t===e,{isArray:h}=Array,p=d("undefined"),g=f("ArrayBuffer"),y=d("string"),m=d("function"),b=d("number"),w=e=>null!==e&&"object"==typeof e,E=e=>{if("object"!==c(e))return!1;let t=l(e);return(null===t||t===Object.prototype||null===Object.getPrototypeOf(t))&&!(Symbol.toStringTag in e)&&!(Symbol.iterator in e)},v=f("Date"),L=f("File"),A=f("Blob"),S=f("FileList"),O=f("URLSearchParams");/**
 ...
 */function(e){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(e):e&&e.buffer&&g(e.buffer)},isString:y,isNumber:b,isBoolean:e=>!0===e||!1===e,isObject:w,isPlainObject:E,isUndefined:p,isDate:v,isFile:L,isBlob:A,isRegExp:j,isFunction:m,isStream:e=>w(e)&&m(e.pipe),isURLSearchParams:O,isTypedArray:C,isFileList:S,forEach:T,merge:/**
 ...
 *
 * @returns {boolean}
 */function(e){return!!(e&&m(e.append)&&"FormData"===e[Symbol.toStringTag]&&e[Symbol.iterator])},toJSONObject:e=>{let t=Array(10),r=(e,n)=>{if(w(e)){if(t.indexOf(e)>=0)return;if(!("toJSON"in e)){t[n]=e;let i=h(e)?[]:{};return T(e,(e,t)=>{let o=r(e,n+1);p(o)||(i[t]=o)}),t[n]=void 0,i}}return e};return r(e,0)},isAsyncFn:D,isThenable:e=>e&&(w(e)||m(e))&&m(e.then)&&m(e.catch)};/**
 ...
 */function I(e,t,r,n,i){Error.call(this),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=Error().stack,this.message=e,this.name="AxiosError",t&&(this.code=t),r&&(this.config=r),n&&(this.request=n),i&&(this.response=i)}M.inherits(I,Error,{toJSON:function(){return{// Standard
...
I.from=(e,t,r,n,i,o)=>{let s=Object.create(q);return M.toFlatObject(e,s,function(e){return e!==Error.prototype},e=>"isAxiosError"!==e),I.call(s,e.message,t,r,n,i),s.cause=e,s.name=e.name,o&&Object.assign(s,o),s},n=function(e){// go through the array every three bytes, we'll deal with trailing stuff later
...
var i=!1;;)switch(t){case"ascii":case"latin1":case"binary":return r;case"utf8":case"utf-8":return ey(e).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return 2*r;case"hex":return r>>>1;case"base64":return em(e).length;default:if(i)return n?-1:ey(e).length// assume utf8
...
if(void 0===t)n="utf8",r=this.length,t=0;else if(void 0===r&&"string"==typeof t)n=t,r=this.length,t=0;else if(isFinite(t))t>>>=0,isFinite(r)?(r>>>=0,void 0===n&&(n="utf8")):(n=r,r=void 0);else throw Error("Buffer.write(string, encoding, offset[, length]) is no longer supported");var i,o,s,a,u,l,c,f,d=this.length-t;if((void 0===r||r>d)&&(r=d),e.length>0&&(r<0||t<0)||t>this.length)throw RangeError("Attempt to write outside buffer bounds");n||(n="utf8");for(var h=!1;;)switch(n){case"hex":return function(e,t,r,n){r=Number(r)||0;var i=e.length-r;n?(n=Number(n))>i&&(n=i):n=i;var o=t.length;n>o/2&&(n=o/2);for(var s=0;s<n;++s){var a=parseInt(t.substr(2*s,2),16);if(a!=a)break;e[r+s]=a}return s}(this,e,t,r);case"utf8":case"utf-8":return i=t,o=r,eb(ey(e,this.length-i),this,i,o);case"ascii":case"latin1":case"binary":return s=t,a=r,eb(function(e){for(var t=[],r=0;r<e.length;++r)t.push(255&e.charCodeAt(r));return t}(e),this,s,a);case"base64":// Warning: maxLength not taken into account in base64Write
...
// ================
var eg=/[^+/0-9A-Za-z-_]/g;function ey(e,t){t=t||1/0;for(var r,n=e.length,i=null,o=[],s=0;s<n;++s){// is surrogate component
 ...
 *
 * @returns {boolean}
 */function ev(e){return M.isPlainObject(e)||M.isArray(e)}/**
 * It removes the brackets from the end of a string
 *
 * @param {string} key - The key of the parameter.
 *
 * @returns {string} the key without the brackets.
 */function eL(e){return M.endsWith(e,"[]")?e.slice(0,-2):e}/**
...
e=eL(e),!r&&t?"["+e+"]":e)}).join(r?".":""):t}const eS=M.toFlatObject(M,{},null,function(e){return/^is[A-Z]/.test(e)});var eO=/**
...
return!M.isUndefined(t[e])});let n=r.metaTokens,i=r.visitor||c,o=r.dots,s=r.indexes,a=r.Blob||"undefined"!=typeof Blob&&Blob,u=a&&M.isSpecCompliantForm(t);if(!M.isFunction(i))throw TypeError("visitor must be a function");function l(e){if(null===e)return"";if(M.isDate(e))return e.toISOString();if(!u&&M.isBlob(e))throw new I("Blob is not supported. Use a Buffer instead.");return M.isArrayBuffer(e)||M.isTypedArray(e)?u&&"function"==typeof Blob?new Blob([e]):X.from(e):e}/**
   * Default visitor.
   *
   * @param {*} value
   ...
   */function c(e,r,i){let a=e;if(e&&!i&&"object"==typeof e){if(M.endsWith(r,"{}"))// eslint-disable-next-line no-param-reassign
r=n?r:r.slice(0,-2),// eslint-disable-next-line no-param-reassign
e=JSON.stringify(e);else{var u;if(M.isArray(e)&&(u=e,M.isArray(u)&&!u.some(ev))||(M.isFileList(e)||M.endsWith(r,"[]"))&&(a=M.toArray(e)))return(// eslint-disable-next-line no-param-reassign
r=eL(r),a.forEach(function(e,n){M.isUndefined(e)||null===e||t.append(!0===s?eA([r],n,o):null===s?r:r+"[]",l(e))}),!1)}}return!!ev(e)||(t.append(eA(i,r,o),l(e)),!1)}let f=[],d=Object.assign(eS,{defaultVisitor:c,convertValue:l,isVisitable:ev});if(!M.isObject(e))throw TypeError("data must be an object");return!function e(r,n){if(!M.isUndefined(r)){if(-1!==f.indexOf(r))throw Error("Circular reference detected in "+n.join("."));f.push(r),M.forEach(r,function(r,o){let s=!(M.isUndefined(r)||null===r)&&i.call(t,r,M.isString(o)?o.trim():o,n,d);!0===s&&e(r,n?n.concat(o):[o])}),f.pop()}}(e),t};/**
 ...
 */function eB(e){return encodeURIComponent(e).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function eC(e,t,r){let n;/*eslint no-param-reassign:0*/if(!t)return e;let i=r&&r.encode||eB,o=r&&r.serialize;if(n=o?o(t,r):M.isURLSearchParams(t)?t.toString():new eR(t,r).toString(i)){let t=e.indexOf("#");-1!==t&&(e=e.slice(0,t)),e+=(-1===e.indexOf("?")?"?":"&")+n}return e}eU.append=function(e,t){this._pairs.push([e,t])},eU.toString=function(e){let t=e?function(t){return e.call(this,t,eT)}:eT;return this._pairs.map(function(e){return t(e[0])+"="+t(e[1])},"").join("&")};var ex=class{constructor(){this.handlers=[]}/**
   ...
   *
   * @returns {void}
   */forEach(e){M.forEach(this.handlers,function(t){null!==t&&e(t)})}},ek={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},ej="undefined"!=typeof URLSearchParams?URLSearchParams:eR,e_="undefined"!=typeof FormData?FormData:null,eN="undefined"!=typeof Blob?Blob:null;/**
...
self instanceof WorkerGlobalScope&&"function"==typeof self.importScripts;var eD={classes:{URLSearchParams:ej,FormData:e_,Blob:eN},isStandardBrowserEnv:eP,isStandardBrowserWebWorkerEnv:eF,protocols:["http","https","file","blob","url","data"]},eM=/**
 * It takes a FormData object and returns a JavaScript object
 *
 * @param {string} formData The FormData object to convert to JSON.
 *
 * @returns {Object<string, any> | null} The converted object.
 */function(e){if(M.isFormData(e)&&M.isFunction(e.entries)){let t={};return M.forEachEntry(e,(e,r)=>{!function e(t,r,n,i){let o=t[i++],s=Number.isFinite(+o),a=i>=t.length;if(o=!o&&M.isArray(n)?n.length:o,a)return M.hasOwnProp(n,o)?n[o]=[n[o],r]:n[o]=r,!s;n[o]&&M.isObject(n[o])||(n[o]=[]);let u=e(t,r,n[o],i);return u&&M.isArray(n[o])&&(n[o]=/**
 * Convert an array to an object.
 *
 * @param {Array<any>} arr - The array to convert to an object.
 *
 * @returns An object with the same keys and values as the array.
 */function(e){let t,r;let n={},i=Object.keys(e),o=i.length;for(t=0;t<o;t++)n[r=i[t]]=e[r];return n}(n[o])),!s}(M.matchAll(/\w+|\[(\w*)]/g,e).map(e=>"[]"===e[0]?"":e[1]||e[0]),r,t,0)}),t}return null};const eI={transitional:ek,adapter:eD.isNode?"http":"xhr",transformRequest:[function(e,t){let r;let n=t.getContentType()||"",i=n.indexOf("application/json")>-1,o=M.isObject(e);o&&M.isHTMLForm(e)&&(e=new FormData(e));let s=M.isFormData(e);if(s)return i&&i?JSON.stringify(eM(e)):e;if(M.isArrayBuffer(e)||M.isBuffer(e)||M.isStream(e)||M.isFile(e)||M.isBlob(e))return e;if(M.isArrayBufferView(e))return e.buffer;if(M.isURLSearchParams(e))return t.setContentType("application/x-www-form-urlencoded;charset=utf-8",!1),e.toString();if(o){if(n.indexOf("application/x-www-form-urlencoded")>-1){var a,u;return(a=e,u=this.formSerializer,eO(a,new eD.classes.URLSearchParams,Object.assign({visitor:function(e,t,r,n){return eD.isNode&&M.isBuffer(e)?(this.append(t,e.toString("base64")),!1):n.defaultVisitor.apply(this,arguments)}},u))).toString()}if((r=M.isFileList(e))||n.indexOf("multipart/form-data")>-1){let t=this.env&&this.env.FormData;return eO(r?{"files[]":e}:e,t&&new t,this.formSerializer)}}return o||i?(t.setContentType("application/json",!1),/**
 ...
 */function(e,t,r){if(M.isString(e))try{return(0,JSON.parse)(e),M.trim(e)}catch(e){if("SyntaxError"!==e.name)throw e}return(0,JSON.stringify)(e)}(e)):e}],transformResponse:[function(e){let t=this.transitional||eI.transitional,r=t&&t.forcedJSONParsing,n="json"===this.responseType;if(e&&M.isString(e)&&(r&&!this.responseType||n)){let r=t&&t.silentJSONParsing;try{return JSON.parse(e)}catch(e){if(!r&&n){if("SyntaxError"===e.name)throw I.from(e,I.ERR_BAD_RESPONSE,this,null,this.response);throw e}}}return e}],/**
   ...
   */timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:eD.classes.FormData,Blob:eD.classes.Blob},validateStatus:function(e){return e>=200&&e<300},headers:{common:{Accept:"application/json, text/plain, */*","Content-Type":void 0}}};M.forEach(["delete","get","head","post","put","patch"],e=>{eI.headers[e]={}});// RawAxiosHeaders whose duplicates are ignored by node
// c.f. https://nodejs.org/api/http.html#http_message_headers
const eq=M.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]);var /**
 ...
 */eH=e=>{let t,r,n;let i={};return e&&e.split("\n").forEach(function(e){n=e.indexOf(":"),t=e.substring(0,n).trim().toLowerCase(),r=e.substring(n+1).trim(),!t||i[t]&&eq[t]||("set-cookie"===t?i[t]?i[t].push(r):i[t]=[r]:i[t]=i[t]?i[t]+", "+r:r)}),i};const ez=Symbol("internals");function e$(e){return e&&String(e).trim().toLowerCase()}function eJ(e){return!1===e||null==e?e:M.isArray(e)?e.map(eJ):String(e)}const eW=e=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(e.trim());function eV(e,t,r,n,i){if(M.isFunction(n))return n.call(this,t,r);if(i&&(t=r),M.isString(t)){if(M.isString(n))return -1!==t.indexOf(n);if(M.isRegExp(n))return n.test(t)}}class eK{constructor(e){e&&this.set(e)}set(e,t,r){let n=this;function i(e,t,r){let i=e$(t);if(!i)throw Error("header name must be a non-empty string");let o=M.findKey(n,i);o&&void 0!==n[o]&&!0!==r&&(void 0!==r||!1===n[o])||(n[o||t]=eJ(e))}let o=(e,t)=>M.forEach(e,(e,r)=>i(e,r,t));return M.isPlainObject(e)||e instanceof this.constructor?o(e,t):M.isString(e)&&(e=e.trim())&&!eW(e)?o(eH(e),t):null!=e&&i(t,e,r),this}get(e,t){if(e=e$(e)){let r=M.findKey(this,e);if(r){let e=this[r];if(!t)return e;if(!0===t)return function(e){let t;let r=Object.create(null),n=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;for(;t=n.exec(e);)r[t[1]]=t[2];return r}(e);if(M.isFunction(t))return t.call(this,e,r);if(M.isRegExp(t))return t.exec(e);throw TypeError("parser must be boolean|regexp|function")}}}has(e,t){if(e=e$(e)){let r=M.findKey(this,e);return!!(r&&void 0!==this[r]&&(!t||eV(this,this[r],r,t)))}return!1}delete(e,t){let r=this,n=!1;function i(e){if(e=e$(e)){let i=M.findKey(r,e);i&&(!t||eV(r,r[i],i,t))&&(delete r[i],n=!0)}}return M.isArray(e)?e.forEach(i):i(e),n}clear(e){let t=Object.keys(this),r=t.length,n=!1;for(;r--;){let i=t[r];(!e||eV(this,this[i],i,e,!0))&&(delete this[i],n=!0)}return n}normalize(e){let t=this,r={};return M.forEach(this,(n,i)=>{let o=M.findKey(r,i);if(o){t[o]=eJ(n),delete t[i];return}let s=e?i.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(e,t,r)=>t.toUpperCase()+r):String(i).trim();s!==i&&delete t[i],t[s]=eJ(n),r[s]=!0}),this}concat(...e){return this.constructor.concat(this,...e)}toJSON(e){let t=Object.create(null);return M.forEach(this,(r,n)=>{null!=r&&!1!==r&&(t[n]=e&&M.isArray(r)?r.join(", "):r)}),t}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([e,t])=>e+": "+t).join("\n")}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(e){return e instanceof this?e:new this(e)}static concat(e,...t){let r=new this(e);return t.forEach(e=>r.set(e)),r}static accessor(e){let t=this[ez]=this[ez]={accessors:{}},r=t.accessors,n=this.prototype;function i(e){let t=e$(e);r[t]||(!function(e,t){let r=M.toCamelCase(" "+t);["get","set","has"].forEach(n=>{Object.defineProperty(e,n+r,{value:function(e,r,i){return this[n].call(this,t,e,r,i)},configurable:!0})})}(n,e),r[t]=!0)}return M.isArray(e)?e.forEach(i):i(e),this}}function eG(e,t){let r=this||eI,n=t||r,i=eK.from(n.headers),o=n.data;return M.forEach(e,function(e){o=e.call(r,o,i.normalize(),t?t.status:void 0)}),i.normalize(),o}function eY(e){return!!(e&&e.__CANCEL__)}/**
 ...
 */function eX(e,t,r){I.call(this,null==e?"canceled":e,I.ERR_CANCELED,t,r),this.name="CanceledError"}eK.accessor(["Content-Type","Content-Length","Accept","Accept-Encoding","User-Agent","Authorization"]),M.reduceDescriptors(eK.prototype,({value:e},t)=>{let r=t[0].toUpperCase()+t.slice(1);// map `set` => `Set`
return{get:()=>e,set(e){this[r]=e}}}),M.freezeMethods(eK),M.inherits(eX,I,{__CANCEL__:!0});var eQ=eD.isStandardBrowserEnv?{write:function(e,t,r,n,i,o){let s=[];s.push(e+"="+encodeURIComponent(t)),M.isNumber(r)&&s.push("expires="+new Date(r).toGMTString()),M.isString(n)&&s.push("path="+n),M.isString(i)&&s.push("domain="+i),!0===o&&s.push("secure"),document.cookie=s.join("; ")},read:function(e){let t=document.cookie.match(RegExp("(^|;\\s*)("+e+")=([^;]*)"));return t?decodeURIComponent(t[3]):null},remove:function(e){this.write(e,"",Date.now()-864e5)}}:{write:function(){},read:function(){return null},remove:function(){}};function eZ(e,t){return e&&!/^([a-z][a-z\d+\-.]*:)?\/\//i.test(t)?t?e.replace(/\/+$/,"")+"/"+t.replace(/^\/+/,""):e:t}var e0=eD.isStandardBrowserEnv?// whether the request URL is of the same origin as current location.
...
u=null},eD.isStandardBrowserEnv){// Add xsrf header
...
void 0===i&&o.setContentType(null),"setRequestHeader"in u&&M.forEach(o.toJSON(),function(e,t){u.setRequestHeader(t,e)}),M.isUndefined(e.withCredentials)||(u.withCredentials=!!e.withCredentials),s&&"json"!==s&&(u.responseType=e.responseType),"function"==typeof e.onDownloadProgress&&u.addEventListener("progress",e2(e.onDownloadProgress,!0)),"function"==typeof e.onUploadProgress&&u.upload&&u.upload.addEventListener("progress",e2(e.onUploadProgress)),(e.cancelToken||e.signal)&&(// Handle cancellation
// eslint-disable-next-line func-names
n=t=>{u&&(r(!t||t.type?new eX(null,e,u):t),u.abort(),u=null)},e.cancelToken&&e.cancelToken.subscribe(n),e.signal&&(e.signal.aborted?n():e.signal.addEventListener("abort",n)));let f=function(e){let t=/^([-+\w]{1,25})(:?\/\/|:)/.exec(e);return t&&t[1]||""}(l);if(f&&-1===eD.protocols.indexOf(f)){r(new I("Unsupported protocol "+f+":",I.ERR_BAD_REQUEST,e));return}// Send the request
u.send(i||null)})};const e6={http:null,xhr:e4};M.forEach(e6,(e,t)=>{if(e){try{Object.defineProperty(e,"name",{value:t})}catch(e){// eslint-disable-next-line no-empty
}Object.defineProperty(e,"adapterName",{value:t})}});var e8={getAdapter:e=>{let t,r;e=M.isArray(e)?e:[e];let{length:n}=e;for(let i=0;i<n&&(t=e[i],!(r=M.isString(t)?e6[t.toLowerCase()]:t));i++);if(!r){if(!1===r)throw new I(`Adapter ${t} is not supported by the environment`,"ERR_NOT_SUPPORT");throw Error(M.hasOwnProp(e6,t)?`Adapter '${t}' is not available in the build`:`Unknown adapter '${t}'`)}if(!M.isFunction(r))throw TypeError("adapter is not a function");return r},adapters:e6};/**
...
function i(e,t,r){return M.isUndefined(t)?M.isUndefined(e)?void 0:n(void 0,e,r):n(e,t,r)}// eslint-disable-next-line consistent-return
function o(e,t){if(!M.isUndefined(t))return n(void 0,t)}// eslint-disable-next-line consistent-return
 ...
 */class ts{constructor(e){this.defaults=e,this.interceptors={request:new ex,response:new ex}}/**
   ...
   */request(e,t){let r,n;"string"==typeof e?(t=t||{}).url=e:t=e||{},t=te(this.defaults,t);let{transitional:i,paramsSerializer:o,headers:s}=t;void 0!==i&&ti.assertOptions(i,{silentJSONParsing:to.transitional(to.boolean),forcedJSONParsing:to.transitional(to.boolean),clarifyTimeoutError:to.transitional(to.boolean)},!1),null!=o&&(M.isFunction(o)?t.paramsSerializer={serialize:o}:ti.assertOptions(o,{encode:to.function,serialize:to.function},!0)),// Set config.method
t.method=(t.method||this.defaults.method||"get").toLowerCase();// Flatten headers
let a=s&&M.merge(s.common,s[t.method]);s&&M.forEach(["delete","get","head","post","put","patch","common"],e=>{delete s[e]}),t.headers=eK.concat(a,s);// filter out skipped interceptors
let u=[],l=!0;this.interceptors.request.forEach(function(e){("function"!=typeof e.runWhen||!1!==e.runWhen(t))&&(l=l&&e.synchronous,u.unshift(e.fulfilled,e.rejected))});let c=[];this.interceptors.response.forEach(function(e){c.push(e.fulfilled,e.rejected)});let f=0;if(!l){let e=[e7.bind(this),void 0];for(e.unshift.apply(e,u),e.push.apply(e,c),n=e.length,r=Promise.resolve(t);f<n;)r=r.then(e[f++],e[f++]);return r}n=u.length;let d=t;for(f=0;f<n;){let e=u[f++],t=u[f++];try{d=e(d)}catch(e){t.call(this,e);break}}try{r=e7.call(this,d)}catch(e){return Promise.reject(e)}for(f=0,n=c.length;f<n;)r=r.then(c[f++],c[f++]);return r}getUri(e){e=te(this.defaults,e);let t=eZ(e.baseURL,e.url);return eC(t,e.params,e.paramsSerializer)}}M.forEach(["delete","get","head","options"],function(e){/*eslint func-names:0*/ts.prototype[e]=function(t,r){return this.request(te(r||{},{method:e,url:t,data:(r||{}).data}))}}),M.forEach(["post","put","patch"],function(e){/*eslint func-names:0*/function t(t){return function(r,n,i){return this.request(te(i||{},{method:e,headers:t?{"Content-Type":"multipart/form-data"}:{},url:r,data:n}))}}ts.prototype[e]=t(),ts.prototype[e+"Form"]=t(!0)});/**
 ...
 */function e(t){let r=new ts(t),n=a(ts.prototype.request,r);return M.extend(n,ts.prototype,r,{allOwnKeys:!0}),M.extend(n,r,null,{allOwnKeys:!0}),// Factory for creating new instances
...
tl.isAxiosError=function(e){return M.isObject(e)&&!0===e.isAxiosError},// Expose mergeConfig
tl.mergeConfig=te,tl.AxiosHeaders=eK,tl.formToJSON=e=>eM(M.isHTMLForm(e)?new FormData(e):e),tl.getAdapter=e8.getAdapter,tl.HttpStatusCode=tu,tl.default=tl;// This module is intended to unwrap Axios default export as named.
// Keep top-level export same with static properties
// so that it can keep same with es module or cjs
const{Axios:tc,AxiosError:tf,CanceledError:td,isCancel:th,CancelToken:tp,VERSION:tg,all:ty,Cancel:tm,isAxiosError:tb,spread:tw,toFormData:tE,AxiosHeaders:tv,HttpStatusCode:tL,formToJSON:tA,getAdapter:tS,mergeConfig:tO}=tl,tT=document.querySelector(".spinner-box"),tR="95f474a01cc4252905d63c7d958d5749",tU=async()=>{tT.classList.remove("spinner-box--hidden");try{let e=await tl.get("https://api.themoviedb.org/3/genre/movie/list",{params:{api_key:tR}}),t=await e.data.genres;return tT.classList.add("spinner-box--hidden"),t}catch(e){console.error(e.message)}},tB=async e=>{tT.classList.remove("spinner-box--hidden");try{let t=tl.get(`https://api.themoviedb.org/3/movie/${e}/videos`,{params:{api_key:tR}});return tT.classList.add("spinner-box--hidden"),t}catch(e){console.log(e)}};async function tC(e,t){tT.classList.remove("spinner-box--hidden");let r=new URLSearchParams(t);try{let t=await tl.get(`${e}?${r}`),n=await t.data;return tT.classList.add("spinner-box--hidden"),n}catch(e){console.log(e)}}async function tx(e){try{let t=await tB(e),r=await t.data.results[0].key;return r}catch(e){console.log(e)}}const tk=document.querySelector(".modal-backdrop");function tj(e){"Escape"===e.key&&(tk.classList.add("is-hidden"),tk.innerHTML="",document.removeEventListener("keydown",tj),document.body.style.overflow="auto")}// PAGINATION STRING
const t_=`<div class="container pagination-section">
...
async function tN(e,t){try{let r=await tC(e,t),n=await r.results;tH(n),tP(e,t)}catch(e){console.log(e)}}function tP(e,t){tM.insertAdjacentHTML("beforeend",t_);let r=t.page,n=document.querySelector(".current-page"),i=document.querySelector(".arrow--left"),o=document.querySelector(".dots--left"),s=document.querySelector(".two-pages--back"),a=document.querySelector(".page--back"),u=document.querySelector(".page--next"),l=document.querySelector(".two-pages--next"),c=document.querySelector(".dots--right"),f=document.querySelector(".page--last"),d=document.querySelector(".arrow--right"),h=document.querySelector(".page--first"),p=document.querySelector(".page--second"),g=document.querySelector(".page--third"),y=document.querySelector(".page--fourth"),m=document.querySelector(".page--fifth"),b=document.querySelector(".page--sixth"),w=document.querySelector(".page--seventh");// RUN CHECKING...
// ASYNC FN TO CHECING PAGE
(async function(){try{let E;let v=await tC(e,t),L=await v.total_pages,A=await v.total_results;// CONDITIONS
switch(E=L,L>=500&&(E=500),f.innerHTML=E,f.addEventListener("click",()=>{t.page=E,tN(e,t)}),r){case E:u.classList.add("hidden"),l.classList.add("hidden"),f.classList.add("hidden"),c.classList.add("hidden"),d.classList.add("hidden");break;case E-1:l.classList.add("hidden"),f.classList.add("hidden"),c.classList.add("hidden");break;case E-2:f.classList.add("hidden"),c.classList.add("hidden");break;case E-3:c.classList.add("hidden")}// CONDITIONS
switch(r){case 1:h.classList.add("hidden"),o.classList.add("hidden"),s.classList.add("hidden"),a.classList.add("hidden"),u.classList.add("hidden"),l.classList.add("hidden"),i.classList.add("hidden");break;case 2:n.innerHTML=`${t.page}`,o.classList.add("hidden"),s.classList.add("hidden"),a.classList.add("hidden"),u.classList.add("hidden"),l.classList.add("hidden"),p.classList.add("hidden");break;case 3:n.innerHTML=`${t.page}`,o.classList.add("hidden"),s.classList.add("hidden"),a.innerHTML=t.page-1,u.classList.add("hidden"),l.classList.add("hidden"),p.classList.add("hidden"),g.classList.add("hidden");break;case 4:n.innerHTML=`${t.page}`,o.classList.add("hidden"),s.innerHTML=t.page-2,a.innerHTML=t.page-1,u.classList.add("hidden"),l.classList.add("hidden"),p.classList.add("hidden"),g.classList.add("hidden"),y.classList.add("hidden");break;default:n.innerHTML=`${t.page}`,s.innerHTML=t.page-2,a.innerHTML=t.page-1,u.innerHTML=t.page+1,l.innerHTML=t.page+2,p.classList.add("hidden"),g.classList.add("hidden"),y.classList.add("hidden"),m.classList.add("hidden"),b.classList.add("hidden"),w.classList.add("hidden")}switch(E){case 7:f.classList.add("hidden"),c.classList.add("hidden");break;case 6:w.classList.add("hidden"),f.classList.add("hidden"),c.classList.add("hidden");break;case 5:b.classList.add("hidden"),w.classList.add("hidden"),f.classList.add("hidden"),c.classList.add("hidden");break;case 4:m.classList.add("hidden"),b.classList.add("hidden"),w.classList.add("hidden"),f.classList.add("hidden"),c.classList.add("hidden");break;case 3:y.classList.add("hidden"),m.classList.add("hidden"),b.classList.add("hidden"),w.classList.add("hidden"),f.classList.add("hidden"),c.classList.add("hidden");break;case 2:g.classList.add("hidden"),y.classList.add("hidden"),m.classList.add("hidden"),b.classList.add("hidden"),w.classList.add("hidden"),f.classList.add("hidden"),c.classList.add("hidden");break;case 1:p.classList.add("hidden"),g.classList.add("hidden"),y.classList.add("hidden"),m.classList.add("hidden"),b.classList.add("hidden"),w.classList.add("hidden"),f.classList.add("hidden"),c.classList.add("hidden")}0===A&&n.classList.add("hidden")}catch(e){console.log(e)}})(),// BUTTONS LISTENERS
h.addEventListener("click",()=>{t.page=1,tN(e,t)}),p.addEventListener("click",()=>{t.page=2,tN(e,t)}),g.addEventListener("click",()=>{t.page=3,tN(e,t)}),y.addEventListener("click",()=>{t.page=4,tN(e,t)}),m.addEventListener("click",()=>{t.page=5,tN(e,t)}),b.addEventListener("click",()=>{t.page=6,tN(e,t)}),w.addEventListener("click",()=>{t.page=7,tN(e,t)}),u.addEventListener("click",()=>{t.page++,tN(e,t)}),l.addEventListener("click",()=>{t.page+=2,tN(e,t)}),a.addEventListener("click",()=>{t.page--,tN(e,t)}),s.addEventListener("click",()=>{t.page-=2,tN(e,t)}),d.addEventListener("click",()=>{t.page++,tN(e,t)}),i.addEventListener("click",()=>{1!==t.page&&(t.page--,tN(e,t))})}function tF(e,t){window.innerWidth<768&&(console.log("przeglądarka mobilna"),document.addEventListener("scroll",function r(){if(window.innerHeight+window.scrollY>=document.body.offsetHeight){console.log("dojechałeś do końca strony"),t.page++,tD(e,t);let n=document.querySelector(".search-form"),i=document.querySelector(".search-form__svg");n.addEventListener("submit",e=>{e.preventDefault(),document.removeEventListener("scroll",r)}),i.addEventListener("click",()=>{document.removeEventListener("scroll",r)})}}))}async function tD(e,t){try{let r=await tC(e,t),n=await r.results;if(t.page>r.total_pages||t.page>500){console.log(`osiągnięto ostatnią stronę`);return}return console.log(`rysowana jest kolejna strona ${t.page} / ${r.total_pages<=500?r.total_pages:500}`),console.log("kolejna strona została narysowana"),tH(n,!1)}catch(e){console.log(e)}}const tM=document.querySelector(".main-section");let tI=[];async function tq(){// const data = await axiosSecondFetchFn()
//   .then(data => {
//     drawFilmBox(data.results);
//   })
//   .catch(error => console.log(error));
let e="https://api.themoviedb.org/3/movie/popular",t={api_key:"95f474a01cc4252905d63c7d958d5749",language:"en-US",page:1};try{let r=await tC(e,t),n=await r.results;return tH(n),tP(e,t),tF(e,t)}catch(e){console.log(e)}}function tH(e,t=!0){let r=[];t&&(tM.innerHTML=""),e.forEach(e=>{//We need to add link that brings us to modal window if we press .main__photo-card
let t=[];for(let r of e.genre_ids)tI.map(e=>{e.id===r&&t.push(e.name)});let n=document.createElement("div");n.classList.add("film-poster"),n.setAttribute("value",e.id),null===e.poster_path&&(e.poster_path="/uc4RAVW1T3T29h6OQdr7zu4Blui.jpg"),n.insertAdjacentHTML("afterbegin",`<img class="film-poster__photo" src="https://image.tmdb.org/t/p/original${e.poster_path}" alt="${e.title}" loading="lazy"/>`);let i=document.createElement("div");i.classList.add("film-poster__description");let o=document.createElement("button");o.classList.add("film-poster__button"),o.setAttribute("type","button"),o.setAttribute("value",`${e.id}`),o.innerHTML="▶",o.addEventListener("click",e=>{tx(e.target.value).then(e=>{!function(e){// `<iframe width="560" height="315" src="https://www.youtube.com/embed/${key}?si=NP4x3PPUZd7lNCFY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`,
let t=document.createElement("div");t.classList.add("modal-trailer"),t.insertAdjacentHTML("afterbegin",`<iframe class="modal-trailer__iframe" src="https://www.youtube.com/embed/${e}?si=NP4x3PPUZd7lNCFY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`),tk.innerHTML="",tk.insertAdjacentElement("afterbegin",t),tk.classList.remove("is-hidden"),document.body.style.overflow="hidden",tk.addEventListener("click",()=>{tk.classList.add("is-hidden"),tk.innerHTML="",document.body.style.overflow="auto"}),document.addEventListener("keydown",tj)}(e)});// showTrailer(trailerKey);
        ...
        </div>`),n.insertAdjacentElement("beforeend",i),r.push(n)}),tM.append(...r)}tU().then(e=>tI.push(...e)).catch(e=>console.log(e));const tz=document.querySelector(".search-form"),t$=document.querySelector(".search-form__input"),tJ=document.querySelector(".search-form__svg");async function tW(e,t){try{let r=await tC(e,t),n=await r.results;return tH(n),tP(e,t),tF(e,t)}catch(e){console.log(e)}}tq(),tz.addEventListener("submit",e=>{e.preventDefault();let t={api_key:"95f474a01cc4252905d63c7d958d5749",language:"en-US",page:1,query:`${t$.value}`};tW("https://api.themoviedb.org/3/search/movie",t)}),tJ.addEventListener("click",e=>{let t={api_key:"95f474a01cc4252905d63c7d958d5749",language:"en-US",page:1,query:`${t$.value}`};tW("https://api.themoviedb.org/3/search/movie",t)});//# sourceMappingURL=index.7a0c2f15.js.map

//# sourceMappingURL=index.7a0c2f15.js.map
