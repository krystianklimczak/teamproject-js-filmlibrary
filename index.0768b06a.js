 ...
 */function(e){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(e):e&&e.buffer&&g(e.buffer)},isString:y,isNumber:b,isBoolean:e=>!0===e||!1===e,isObject:w,isPlainObject:v,isUndefined:p,isDate:E,isFile:L,isBlob:A,isRegExp:j,isFunction:m,isStream:e=>w(e)&&m(e.pipe),isURLSearchParams:O,isTypedArray:x,isFileList:S,forEach:T,merge:/**
...
var ev=function(){for(var e="0123456789abcdef",t=Array(256),r=0;r<16;++r)for(var n=16*r,i=0;i<16;++i)t[n+i]=e[r]+e[i];return t}();/**
 * Determines if the given thing is a array or js object.
 *
 * @param {string} thing - The object or array to be visited.
 *
 * @returns {boolean}
 */function eE(e){return D.isPlainObject(e)||D.isArray(e)}/**
 ...
 */function eB(e){return encodeURIComponent(e).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function ex(e,t,r){let n;/*eslint no-param-reassign:0*/if(!t)return e;let i=r&&r.encode||eB,o=r&&r.serialize;if(n=o?o(t,r):D.isURLSearchParams(t)?t.toString():new eR(t,r).toString(i)){let t=e.indexOf("#");-1!==t&&(e=e.slice(0,t)),e+=(-1===e.indexOf("?")?"?":"&")+n}return e}eU.append=function(e,t){this._pairs.push([e,t])},eU.toString=function(e){let t=e?function(t){return e.call(this,t,eT)}:eT;return this._pairs.map(function(e){return t(e[0])+"="+t(e[1])},"").join("&")};var eC=class{constructor(){this.handlers=[]}/**
...
if(u.open(e.method.toUpperCase(),ex(l,e.params,e.paramsSerializer),!0),// Set the request timeout in MS
 ...
 */class ts{constructor(e){this.defaults=e,this.interceptors={request:new eC,response:new eC}}/**
   * Dispatch a request
   *
...
let t=document.createElement("div");t.classList.add("modal-trailer"),t.insertAdjacentHTML("afterbegin",`<iframe class="modal-trailer__iframe" src="https://www.youtube.com/embed/${e}?si=NP4x3PPUZd7lNCFY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`),tk.innerHTML="",tk.insertAdjacentElement("afterbegin",t),tk.classList.remove("is-hidden"),document.body.style.overflow="hidden",tk.addEventListener("click",()=>{tk.classList.add("is-hidden"),tk.innerHTML="",document.body.style.overflow="auto"}),document.addEventListener("keydown",tj)}(e)});// showTrailer(trailerKey);
        ...
        </div>`),n.insertAdjacentElement("beforeend",i),r.push(n)}),tD.append(...r)}tU().then(e=>tI.push(...e)).catch(e=>console.log(e));const tz=document.querySelector(".search-form"),t$=document.querySelector(".search-form__input"),tJ=document.querySelector(".search-form__svg");async function tW(e,t){try{let r=await tx(e,t),n=await r.results;return tH(n),tP(e,t),tF(e,t)}catch(e){console.log(e)}}const tV=document.querySelector(".arrow");tV.addEventListener("click",()=>{window.scroll({top:0,behavior:"smooth"})}),tq(),tz.addEventListener("submit",e=>{e.preventDefault();let t={api_key:"95f474a01cc4252905d63c7d958d5749",language:"en-US",page:1,query:`${t$.value}`};tW("https://api.themoviedb.org/3/search/movie",t)}),tJ.addEventListener("click",e=>{let t={api_key:"95f474a01cc4252905d63c7d958d5749",language:"en-US",page:1,query:`${t$.value}`};tW("https://api.themoviedb.org/3/search/movie",t)});//# sourceMappingURL=index.0768b06a.js.map

//# sourceMappingURL=index.0768b06a.js.map
