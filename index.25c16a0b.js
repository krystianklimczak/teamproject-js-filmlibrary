 ...
 *
 * @returns {boolean}
 */function(t){return!!(t&&m(t.append)&&"FormData"===t[Symbol.toStringTag]&&t[Symbol.iterator])},toJSONObject:t=>{let e=Array(10),r=(t,n)=>{if(w(t)){if(e.indexOf(t)>=0)return;if(!("toJSON"in t)){e[n]=t;let o=d(t)?[]:{};return T(t,(t,e)=>{let i=r(t,n+1);p(i)||(o[e]=i)}),e[n]=void 0,o}}return t};return r(t,0)},isAsyncFn:M,isThenable:t=>t&&(w(t)||m(t))&&m(t.then)&&m(t.catch)};/**
...
J["-".charCodeAt(0)]=62,J["_".charCodeAt(0)]=63,o=function(t,e,r,n,o){var i,s,a=8*o-n-1,u=(1<<a)-1,l=u>>1,c=-7,f=r?o-1:0,h=r?-1:1,d=t[e+f];for(f+=h,i=d&(1<<-c)-1,d>>=-c,c+=a;c>0;i=256*i+t[e+f],f+=h,c-=8);for(s=i&(1<<-c)-1,i>>=-c,c+=n;c>0;s=256*s+t[e+f],f+=h,c-=8);if(0===i)i=1-l;else{if(i===u)return s?NaN:(d?-1:1)*(1/0);s+=Math.pow(2,n),i-=l}return(d?-1:1)*s*Math.pow(2,i-n)},i=function(t,e,r,n,o,i){var s,a,u,l=8*i-o-1,c=(1<<l)-1,f=c>>1,h=23===o?5960464477539062e-23:0,d=n?0:i-1,p=n?1:-1,y=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(a=isNaN(e)?1:0,s=c):(s=Math.floor(Math.log(e)/Math.LN2),e*(u=Math.pow(2,-s))<1&&(s--,u*=2),s+f>=1?e+=h/u:e+=h*Math.pow(2,1-f),e*u>=2&&(s++,u/=2),s+f>=c?(a=0,s=c):s+f>=1?(a=(e*u-1)*Math.pow(2,o),s+=f):(a=e*Math.pow(2,f-1)*Math.pow(2,o),s=0));o>=8;t[r+d]=255&a,d+=p,a/=256,o-=8);for(s=s<<o|a,l+=o;l>0;t[r+d]=255&s,d+=p,s/=256,l-=8);t[r+d-p]|=128*y};var G="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
r=tA(r),a.forEach(function(t,n){I.isUndefined(t)||null===t||e.append(!0===s?tL([r],n,i):null===s?r:r+"[]",l(t))}),!1)}}return!!tv(t)||(e.append(tL(o,r,i),l(t)),!1)}let f=[],h=Object.assign(tS,{defaultVisitor:c,convertValue:l,isVisitable:tv});if(!I.isObject(t))throw TypeError("data must be an object");return!function t(r,n){if(!I.isUndefined(r)){if(-1!==f.indexOf(r))throw Error("Circular reference detected in "+n.join("."));f.push(r),I.forEach(r,function(r,i){let s=!(I.isUndefined(r)||null===r)&&o.call(e,r,I.isString(i)?i.trim():i,n,h);!0===s&&t(r,n?n.concat(i):[i])}),f.pop()}}(t),e};/**
...
async function eF(){try{let t=await eP(e_),e=await t.results;return eD(e)}catch(t){console.log(t)}}const eM=document.querySelector(".main-section");let eI=[];function eD(t){let e=[];eM.innerHTML="",t.forEach(t=>{//We need to add link that brings us to modal window if we press .main__photo-card
...
let t=document.querySelector(".current-page"),e=document.querySelector(".arrow--left"),r=document.querySelector(".dots--left"),n=document.querySelector(".two-pages--back"),o=document.querySelector(".page--back"),i=document.querySelector(".page--next"),s=document.querySelector(".two-pages--next"),a=document.querySelector(".dots--right"),u=document.querySelector(".page--last"),l=document.querySelector(".arrow--right"),c=document.querySelector(".page--first"),f=document.querySelector(".page--second"),h=document.querySelector(".page--third"),d=document.querySelector(".page--fourth"),p=document.querySelector(".page--fifth"),y=document.querySelector(".page--sixth"),g=document.querySelector(".page--seventh");// CONDITIONS
switch(// LAST PAGE
u.innerHTML=500,u.addEventListener("click",()=>{e_=500,eF()}),e_){case 1:c.classList.add("hidden"),r.classList.add("hidden"),n.classList.add("hidden"),o.classList.add("hidden"),i.classList.add("hidden"),s.classList.add("hidden"),e.classList.add("hidden");break;case 2:t.innerHTML=`${e_}`,r.classList.add("hidden"),n.classList.add("hidden"),o.classList.add("hidden"),i.classList.add("hidden"),s.classList.add("hidden"),f.classList.add("hidden");break;case 3:t.innerHTML=`${e_}`,r.classList.add("hidden"),n.classList.add("hidden"),o.innerHTML=e_-1,i.classList.add("hidden"),s.classList.add("hidden"),f.classList.add("hidden"),h.classList.add("hidden");break;case 4:t.innerHTML=`${e_}`,r.classList.add("hidden"),n.innerHTML=e_-2,o.innerHTML=e_-1,i.classList.add("hidden"),s.classList.add("hidden"),f.classList.add("hidden"),h.classList.add("hidden"),d.classList.add("hidden");break;case 500:i.classList.add("hidden"),s.classList.add("hidden"),u.classList.add("hidden"),a.classList.add("hidden"),l.classList.add("hidden");case 499:s.classList.add("hidden"),u.classList.add("hidden"),a.classList.add("hidden");case 498:u.classList.add("hidden"),a.classList.add("hidden");case 497:a.classList.add("hidden");default:t.innerHTML=`${e_}`,n.innerHTML=e_-2,o.innerHTML=e_-1,i.innerHTML=e_+1,s.innerHTML=e_+2,f.classList.add("hidden"),h.classList.add("hidden"),d.classList.add("hidden"),p.classList.add("hidden"),y.classList.add("hidden"),g.classList.add("hidden")}// BUTTONS LISTENERS
c.addEventListener("click",()=>{e_=1,eF()}),f.addEventListener("click",()=>{e_=2,eF()}),h.addEventListener("click",()=>{e_=3,eF()}),d.addEventListener("click",()=>{e_=4,eF()}),p.addEventListener("click",()=>{e_=5,eF()}),y.addEventListener("click",()=>{e_=6,eF()}),g.addEventListener("click",()=>{e_=7,eF()}),i.addEventListener("click",()=>{e_++,eF()}),s.addEventListener("click",()=>{e_+=2,eF()}),o.addEventListener("click",()=>{e_--,eF()}),n.addEventListener("click",()=>{e_-=2,eF()}),l.addEventListener("click",()=>{e_++,eF()}),e.addEventListener("click",()=>{1!==e_&&(e_--,eF())})}()}eB().then(t=>eI.push(...t)).catch(t=>console.log(t)),async function(){await eU().then(t=>{eD(t.results)}).catch(t=>console.log(t))}();// makeFilmsBoxByPage();
//# sourceMappingURL=index.25c16a0b.js.map
